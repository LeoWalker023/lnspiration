(() => {
  ...
  const audience = isAirename ? ["设计师与视觉团队", "游戏、美术与素材制作团队", "需要整理大量图片资源的个人创作者"] : isPlugin ? ["使用 Animator 驱动角色、道具或 UI 动画的 Unity 项目", "需要频繁调整层级结构的美术与技术美术团队", "希望重构节点命名而不破坏动画的开发者"] : isDependency ? ["需要清理大型 Unity 项目的开发者", "希望定位资源引用关系的技术美术与工具团队", "准备迁移、重构或删除资产的项目维护者"] : ["经常阅读外文资料的人", "需要跨语言沟通的设计与开发团队", "希望减少窗口切换的效率型用户"];
  const workflow = isAirename ? [{n:"01",t:"导入素材",d:"拖入图片、PSD 或 PSB，建立清晰的资产处理队列。"},{n:"02",t:"设置规则",d:"选择标签、匹配、序列化、增删剪裁或 AI 精准映射。"},{n:"03",t:"检查预览",d:"同时确认名称、格式、画布、背景和覆盖方式。"},{n:"04",t:"批量处理",d:"处理选中项或全部资源，导出副本或安全覆盖原文件。"}] : isPlugin ? [{n:"01",t:"创建 Animator",d:"在角色、道具或 UI 对象上准备 Animator 与动画控制器。"},{n:"02",t:"挂载保护组件",d:"将 Animation Path Protector 挂载到 Animator 对象，建立动画路径快照。"},{n:"03",t:"自由修改层级",d:"随意移动节点、调整层级、修改名称或重构对象结构。"},{n:"04",t:"自动接驳动画",d:"插件识别变化并同步动画曲线路径，让原有动画继续正确工作。"}] : isDependency ? [{n:"01",t:"导入范围",d:"从 Project 窗口拖入一个或多个资产、文件夹或代码文件。"},{n:"02",t:"选择方向",d:"查看当前资产的正向依赖，或反查项目中使用它的资源。"},{n:"03",t:"定位检查",d:"切换直接或递归模式，定位材质、场景、预制体与代码引用。"},{n:"04",t:"预览清理",d:"勾选来源和专用依赖，在保护规则下确认最终删除清单。"}] : [{n:"01",t:"唤出翻译",d:"按下全局快捷键，不离开当前网页、文档或应用。"},{n:"02",t:"确认语言",d:"选择输入与输出语言，使用适合当前任务的翻译服务。"},{n:"03",t:"阅读结果",d:"在轻量窗口中查看译文，继续保持当前工作节奏。"},{n:"04",t:"安静常驻",d:"关闭窗口后回到托盘，需要时再次呼出。"}];
  ...
  const stories = (p.stories || []).map((s, i) => `<article class="page-story ${i % 2 ? "reverse" : ""}"><div class="story-copy"><p class="eyebrow">${escape(p.fullName)}</p><h2>${escape(s.title)}</h2><p>${escape(s.text)}</p></div><figure class="${s.image ? "zoomable" : ""}">${s.image ? `<img src="${escape(s.image)}" alt="${escape(s.alt)}" loading="lazy">` : renderStoryVisual(s.visual)}</figure></article>`).join("");
